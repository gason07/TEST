<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Post_BanTinDuBao.aspx.cs" Inherits="TEST.TestForm.Post_BanTinDuBao" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Đăng bài bản tin dự báo</title>
    ...
    <script>
        ...
        function closeModal() {
            ...
            window.location.href = "Post_BanTinDuBao.aspx"; //Sau khi đóng hộp thoại thì reset về lại trang Post_BanTinDuBao
        }

        function confirmUpload() {
            return confirm('Bạn có muốn đăng bản tin?');
        }
    </script>
</head>
<body>
    ...
    <div>
        <center>
            <h1>Nội Dung Bản Tin Cần Đăng</h1>
            <h2>*************************</h2>
        </center>
    </div>
        <div>
            <div style="display: flex; justify-content: space-around;">
             ...
             <textarea id="txtTieuDe" name="txtTieuDe" cols="70" rows ="2"></textarea>

             <label for="txtTomTatNoiDung">Tóm Tắt Nội Dung:</label>
             <textarea id="txtTomTatNoiDung" name="txtTomTatNoiDung" cols="70" rows ="4"></textarea>

            <label for="txtNoiDung">Nội Dung:</label>
            <textarea id="txtNoiDung" name="txtNoiDung" cols="120" rows ="15"></textarea>
             ...
             <div>
                <center>
                    <asp:Button ID="btnUpload" runat="server" Text="ĐĂNG TẢI BẢN TIN" OnClientClick="return confirmUpload();" OnClick="btnUpload_Click" BackColor="#009900"/>
                </center>
            </div>
