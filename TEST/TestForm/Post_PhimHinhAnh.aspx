<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Post_PhimHinhAnh.aspx.cs" Inherits="TEST.TestForm.Post_PhimHinhAnh" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Đăng thông tin phim, ảnh</title>
    ...
    <style>
     ...
     <script>
        ...
        function closeModal() {
            ...
            window.location.href = "Post_PhimHinhAnh.aspx";
        }

        function confirmUpload() {
            return confirm('Bạn chắc chắn muốn đăng thông tin phim/ảnh ?');
        }
    </script>
</head>
<body>
    ...
    <div>
        <center>
            <h1>Nội Dung Thông Tin Phim,Ảnh</h1>
            <h2>*************************</h2>
        </center>
    </div>
    <div>
        <label for="txtTieuDe">Tiêu Đề:</label>
        <textarea id="txtTieuDe" name="txtTieuDe" cols="50" rows ="2"></textarea>

        <div class="textBoxContainer">
          <label for="txtNgayThang">Ngày Tháng:</label>
          <asp:TextBox ID="txtNgayThang" runat="server" placeholder="Chọn ngày tháng"></asp:TextBox>
